...
if(isset($_POST["kaydet"]))
{
   //KULLANICI ADI DOGRULAMA SORGULARI
    ...
    //PAROLA TEKRARI DOGRULAMA SORGULARI
    ...
    if (isset($username) && isset($email) && isset($parola) && isset($parolatkr)) {
      ...
      $kontrol = "SELECT COUNT(*) as sayi FROM kullanicilar WHERE kullanici_adi = '$username'";
      $calistir_kontrol = mysqli_query($baglanti, $kontrol);
      $sonuc_kontrol = mysqli_fetch_assoc($calistir_kontrol);

      if ($sonuc_kontrol['sayi'] > 0) {
          ...
          if ($calistirekle) {
              ...
              $error_code = mysqli_errno($baglanti);
              echo '<div class="alert alert-danger" role="alert">
                      Kayıt eklenirken bir problem oluştu. Hata Kodu: ' . $error_code . '
                    </div>';
          }
      }
...
<html lang="en">
 ...
 <div class="mb-3">
    ...
    " id="exampleInputEmail1" name="email" maxlength="50">
    <div class="invalid-feedback">
      <?php echo $email_err; ?>
    </div>
  </div>
  ...
  <div class="mb-3">
    ...
    ?>
    " id="exampleInputPassword1" name="parolatkr" maxlength="30">
    <div class="invalid-feedback">
  ...
  <button type="submit" class="btn btn-primary" name="kaydet">KAYDET</button>
        ...
        <div class="girisbutonu">
        <p><a class="link-opacity-100" href="login.php">Giriş Yap</a></p>
      </div>
    </div>
