...
<head>
    ...
    <title>Servisteki Cihazlar</title>
	<!-- BOOTSTRAP STYLES-->
...
?>             
         <div class="tablolar">
                    <input class="search" type="text" id="searchInput" onkeyup="searchTable()" placeholder="Servis Türü ve Teknisyen Ara">
                ...
                <table id="table" class="table table-bordered table-striped">
                    ...
                    while ($bilgiler_row = $bilgiler_result->fetch_assoc() ) {
                        ...
                        echo "<td>" . $bilgiler_row["servisturu"] . "</td>";
                        echo "<td>" . $bilgiler_row["gelistarihi"] . "</td>";
                        echo "<td>" . $bilgiler_row["servistarihi"] . "</td>";
                        echo "<td>" . $bilgiler_row["teknisyen"] . "</td>";
                        echo "<td>" . $bilgiler_row["disservisbolgesi"] . "</td>";
                        echo "</tr>";
                    }
